...
int main(int argc, char** argv)
{
    ...
    // // set socket low limit
    // int rcvlowat = 20;
    // if(setsockopt(sock, SOL_SOCKET, SO_RCVLOWAT, &rcvlowat, sizeof(rcvlowat))){
    //     perror("[set socket low limit failed]");
    //     exit(EXIT_FAILURE);
    // }
    ...
    auto res = recv(connfd,buffer,20, MSG_WAITALL);
